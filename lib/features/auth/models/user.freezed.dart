...
class _$UserImpl implements _User {
  _$UserImpl(
      {@JsonKey(name: 'user') required this.id,
...
abstract class _User implements User {
  factory _User(
      {@JsonKey(name: 'user') required final String id,
      @JsonKey(name: 'text') required final String description}) = _$UserImpl;
